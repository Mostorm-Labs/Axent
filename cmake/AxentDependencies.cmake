set(AXENT_THIRD_PARTY_DIR "${CMAKE_CURRENT_SOURCE_DIR}/third_party" CACHE PATH "Axent third-party dependency root")

set(AXENT_BUILD_CONCRETE_TRANSPORT_DEPS ON CACHE BOOL "Build Axent-owned concrete transport dependencies")
set(AXENT_USE_EXTERNAL_AXTP_RUNTIME OFF CACHE BOOL "Use AXTP runtime targets already provided by a parent project")

function(axent_require_target target_name message_text)
...
if(AXENT_USE_EXTERNAL_AXTP_RUNTIME)
    ...
    axent_require_target(axtp::runtime "AXENT_USE_EXTERNAL_AXTP_RUNTIME requires axtp::runtime")
